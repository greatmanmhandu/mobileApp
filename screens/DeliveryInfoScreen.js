...
const DeliveryInfoScreen = () => {
    ...
    const handleDeliveryButton = async () => {
        ...
        try {
            ...
            const response = await axios.post(BASE_URL + 'delivery', {
            ...
            setErrorMessage("Successfully added delivery information")
    ...
    return (
        <>
            ...
            <View style={styles.wrapperContainer}>
                ...
                <Text style={styles.subheading}>Give details of your delivery information</Text>
                ...
                {errorMessage !== '' && (
                    ...
                    <View>
                                ...
                                renderButton={(selectedItem, isOpened) => {
                                    return (
                                        <View style={styles.dropdownButtonStyle}>
                                            ...
                                            <Text style={styles.dropdownButtonTxtStyle}>
                                                {(selectedItem && selectedItem.title) || 'What delivery method are you planning to choose for this pregnancy?'}
                                            </Text>
                                            <Icon name={isOpened ? 'chevron-up' : 'chevron-down'} style={styles.dropdownButtonArrowStyle} />
                                        </View>
                                    );
                        ...
                        <View style={styles.inputContainer}>
                            <TextInput
                                style={styles.input}
                                placeholder="How old is your pregnance ? ( number in weeks )"
                                value={pregAge}
                        ...
                        <View style={styles.inputContainer}>
                            <TextInput
                                ...
                                value={otherInfor}
                                onChangeText={(text) => setOtherInfor(text)}
                            />
                        </View>
                        ...
                        <View style={styles.inputContainer}>
                            <View style={styles.buttonContainer}>
                                ...
                                >
                                    <Text style={styles.buttonText}>Update pregnancy Information</Text>
                                </TouchableOpacity>
                            </View>
                        </View>
